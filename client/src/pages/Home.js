      ...
      <nav className="bg-green-100 md:border-0 border-b-2 border-gray-200 z-100 sticky h-18 top-0">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex space-x-2 px-8">
            <a className="bg-green-500 py-2 px-5 rounded-3xl text-white hover:shadow-md" href="#">
              Login
            </a>
            <a className="bg-green-500 py-2 px-5 rounded-3xl text-white hover:shadow-md" href="/signup">
              Sign up
            </a>
          </div>
        </div>
